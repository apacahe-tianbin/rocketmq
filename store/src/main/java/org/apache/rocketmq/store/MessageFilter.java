...
public interface MessageFilter {
     ...
     * @param cqExtUnit extend unit of consume queue consumeQueue扩展属性
     */
    boolean isMatchedByConsumeQueue(final Long tagsCode,
        final ConsumeQueueExt.CqExtUnit cqExtUnit);

    /**
     * 根据存储在ommitlog文件中的内容判断消息是否匹配
     ...
     * @param properties message properties, should decode from buffer if null by yourself. 消息属性，主要用户域SQL92过滤表达式
     */
